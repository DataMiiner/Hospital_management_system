...
if "username" not in st.session_state:
    st.session_state["username"]="DataMiiner"
...
def main():
    ...
    if  side_bar=="Home":
      ...
      st.write("By DataMiiner")
      st.success("Please Enter the Name")
      a=st.text_input("Enter Hospital Name:")
      st.session_state["enter"]=st.button("Enter")
